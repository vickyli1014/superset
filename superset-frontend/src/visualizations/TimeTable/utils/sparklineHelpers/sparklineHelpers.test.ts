...
test('getSparklineTextWidth should return a positive number for text width', () => {
...
test('getSparklineTextWidth should handle empty string', () => {
  const result = getSparklineTextWidth('');
  expect(result).toBeGreaterThan(0);
});

test('isValidBoundValue should return true for valid numbers', () => {
...
test('isValidBoundValue should return false for invalid values', () => {
...
test('getDataBounds should return correct min and max for valid data', () => {
...
test('getDataBounds should handle single value', () => {
  const data = [42];
  const [min, max] = getDataBounds(data);
...
test('getDataBounds should return [0, 0] for empty data', () => {
  const data: number[] = [];
  const [min, max] = getDataBounds(data);
...
test('getDataBounds should handle negative numbers', () => {
  const data = [-10, -5, -20];
  const [min, max] = getDataBounds(data);
...
test('createYScaleConfig should use data bounds when no axis bounds provided', () => {
...
test('createYScaleConfig should use provided bounds when valid', () => {
  const validData = [10, 20, 30];
...
test('createYScaleConfig should mix data and provided bounds', () => {
  const validData = [10, 20, 30];
...
test('createYScaleConfig should handle empty data', () => {
...
test('createYScaleConfig should set zero=true for negative min bound', () => {
...
test('createYScaleConfig should set zero=false for positive min bound', () => {
  const validData = [10, 20];
  const result = createYScaleConfig(validData, [5, undefined]);
...
test('transformChartData should transform data with indices', () => {
  const data = [10, 20, 30];
...
test('transformChartData should handle null values', () => {
...
test('transformChartData should handle empty array', () => {
...
test('transformChartData should handle mixed null and number values', () => {
