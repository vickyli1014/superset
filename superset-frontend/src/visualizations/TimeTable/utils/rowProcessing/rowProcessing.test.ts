...
test('processTimeTableData should convert data to sorted entries', () => {
...
test('processTimeTableData should create reversed entries', () => {
  const result = processTimeTableData(mockData);
...
test('processTimeTableData should sort data entries by time regardless of input order', () => {
  const unsortedData = {
    '2023-01-03': { sales: 300 },
    '2023-01-01': { sales: 100 },
    '2023-01-02': { sales: 200 },
...
test('processTimeTableData should handle empty data', () => {
...
test('processTimeTableData should preserve all data fields', () => {
  const complexData = {
...
test('processTimeTableData should handle single entry', () => {
  const singleData = {
    '2023-01-01': { sales: 100 },
  };
